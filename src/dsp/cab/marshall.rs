...
/// mode sits lower.
///
/// Greenback close-mic (SM57) signature (the skeleton):
...
const ROOM_TEX_L: Texture = Texture {
    ...
    modes: &[(72.0, 260.0, 0.10), (170.0, 130.0, 0.055)],
};
const ROOM_TEX_R: Texture = Texture {
    ...
    modes: &[(76.0, 270.0, 0.09), (180.0, 135.0, 0.05)],
};
...
impl MarshallCab {
    ...
    fn voicing_ribbon(sr: f32) -> impl FnMut(f32) -> f32 {
        let mut bands = [
            ...
            Biquad::peak_eq(sr, 250.0, 1.5, -2.0),
            Biquad::peak_eq(sr, 800.0, 1.3, 3.5),
