...
impl AmpModel {
    ...
    /// Short name for the amp selector widget where space is limited.
...
impl DspChain {
    ...
    pub fn process(&mut self, sample: f32) -> f32 {
        ...
        // Pedal chain — each pedal bypassed when disabled
        ...
        // Amp — model selected at audio-thread read time, all instances kept alive
